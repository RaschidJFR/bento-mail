...
/**
 * Extracts newsletter articles from Markdown content using GPT
 * @param {string} markdownContent - The Markdown content of the newsletter
 * @returns {Promise<Array>} Array of article objects
 */
export async function extractNewsletterArticles(markdownContent) {
...
export async function processNewsletterFile(htmlFilePath) {
  try {
    ...
    return await extractNewsletterArticles(markdownContent);
  } catch (error) {
